...
<style>
body {
    background-image: url('C:\xampp\htdocs\library-project\images'); /* Replace 'your_image_path.jpg' with the actual path to your background image */
...
<marquee class="clg" direction="right" behavior="alternate" scrollamount="1">MSRIT</marquee>
</div>
<br />
